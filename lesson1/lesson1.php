...
class Car{
    ...
    public function __construct($brand = "", $color = "", $power = "",$fuelConsumption = 0, $tankVolume = 0, $driver = "") {
        $this -> brand = $brand;
        $this -> color = $color;
        $this -> power = $power;
...
class Truck extends Car{
    ...
    public function __construct($brand = "", $color = "", $power = "",$fuelConsumption = 0, $tankVolume = 0,$maxTonnage = 0,$cargoWeight = 0) {
        parent::__construct($brand, $color, $power,$fuelConsumption, $tankVolume);
        $this -> maxTonnage = $maxTonnage;
        $this -> cargoWeight = $cargoWeight;
    }

    public function remainingSpace($volume){
    ...
    public function addLoad($volume){
        ...
        $freeSpace = $this -> remainingSpace($volume);
